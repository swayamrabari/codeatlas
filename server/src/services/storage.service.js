  ...
  for (const [keyword, feature] of Object.entries(features)) {
    ...
    featureDocs.push({
      ...
      categorizedFiles: {
        ...
        jobs: feature.categorized?.jobs || [],
        events: feature.categorized?.events || [],
        migrations: feature.categorized?.migrations || [],
        seeds: feature.categorized?.seeds || [],
        validators: feature.categorized?.validators || [],
        pages: feature.categorized?.pages || [],
        components: feature.categorized?.components || [],
        hooks: feature.categorized?.hooks || [],
        contexts: feature.categorized?.contexts || [],
        stores: feature.categorized?.stores || [],
        api: feature.categorized?.api || [],
        layouts: feature.categorized?.layouts || [],
        guards: feature.categorized?.guards || [],
        styles: feature.categorized?.styles || [],
        assets: feature.categorized?.assets || [],
        utils: feature.categorized?.utils || [],
        types: feature.categorized?.types || [],
        constants: feature.categorized?.constants || [],
        tests: feature.categorized?.tests || [],
        mocks: feature.categorized?.mocks || [],
        other: feature.categorized?.other || [],
      },
