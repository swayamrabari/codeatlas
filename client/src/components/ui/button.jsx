  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap cursor-pointer rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        destructiveoutline:
          'border-[1.5px] font-medium border-destructive text-destructive bg-destructive/10 shadow-xs hover:bg-destructive/20 hover:text-destructive-foreground dark:border-destructive/60 dark:text-destructive',
        outline:
        ...
        disabled:
          'bg-primary/50 text-primary-foreground cursor-not-allowed hover:bg-primary/50 pointer-events-none',
      },
      size: {
        ...
        icon: 'size-8 rounded-md p-0 [&_svg:not([class*="size-"])]:size-6',
        'icon-xs': "size-7 rounded-md [&_svg:not([class*='size-'])]:size-5",
